...
BOARD_MAIN_SIZE := 7516192768 # (BOARD_SUPER_PARTITION_SIZE - 4MB)
...
LZMA_RAMDISK_TARGET_WITH_SET_OUT_FILE := true
...
TARGET_OTG_CAPABILITY := true

# Disabling built-in heavy tools
FOX_EXCLUDE_NANO := 1
FOX_EXCLUDE_TIDY_LOGS := 1
